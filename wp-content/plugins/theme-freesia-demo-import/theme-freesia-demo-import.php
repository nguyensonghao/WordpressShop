...
if ($arise_plus || $freesiaempire_plus || $edge_plus || $pixgraphy_plus || $event_plus || $excellent_plus || $idyllic_plus || $storexmas_plus || $magbook_plus || $photograph_plus || $extension_plus || $shoppingcart_plus || $cocktail_plus ) {
